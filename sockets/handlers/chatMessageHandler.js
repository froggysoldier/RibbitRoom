...
/help - Zeigt diese Nachricht`,
      ...
      if (banMatch) {
        ...
        if (!providedPass) return socket.emit("systemMessage", { text: "Admin-Passwort fehlt.", type: "error" });
      ...
      return; // Befehle werden nicht als normale Nachricht gespeichert
    }
